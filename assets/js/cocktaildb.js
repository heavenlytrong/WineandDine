...
function extractData(staticResponseDrink) {
    ...
    drinkId = randomEntry['idDrink'];
    drinkPic = randomEntry['strDrinkThumb'];
...
function displayData() {
    ...
    */
    ...
    //var newList = updatedIngredients.split(',')
    //console.log(newList)
console.log(Object.values(ingredientsArray))

    document.getElementById('cocktailTitle').innerHTML += "<p>" + drinkStr + "</p>";
    document.getElementById('cocktailIng').innerHTML += "<p>" + /*updatedIngredientsnewList + updatedMeasurements*/ ingredientsArray + "</p>";
    document.getElementById('cocktailIns').innerHTML += "<p>" + instructions + "</p>";
    document.getElementById('cocktailImg').src = drinkPic; 
